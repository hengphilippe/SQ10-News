...
<div class="aside-widget">
    ...
    <div class="post post-widget">
        <a class="post-img" href="blog-post.html"><img src="{{ asset('images/img/xwidget-1.jpg.pagespeed.ic.NYJjOYjv_V.webp') }}"
                alt=""></a>
        <div class="post-body">
    ...
    <div class="post post-widget">
        <a class="post-img" href="blog-post.html"><img src="{{ asset('images/img/xwidget-2.jpg.pagespeed.ic.cSUEAOhjjU.webp') }}"
                alt=""></a>
        <div class="post-body">
    ...
    <div class="post post-widget">
        <a class="post-img" href="blog-post.html"><img src="{{ asset('images/img/xwidget-3.jpg.pagespeed.ic.5z-SP7IbT6.webp') }}"
                alt=""></a>
        <div class="post-body">
    ...
    <div class="post post-widget">
        <a class="post-img" href="blog-post.html"><img src="{{ asset('images/img/xwidget-4.jpg.pagespeed.ic.i3iWR0f20S.webp') }}"
                alt=""></a>
        <div class="post-body">
            <h3 class="post-title"><a href="blog-post.html">Tell-A-Tool: Guide To Web Design
                    And Development Tools</a></h3>
...
<div class="aside-widget">
    ...
    <div class="post post-thumb">
        <a class="post-img" href="blog-post.html"><img src="{{ asset('images/img/xpost-2.jpg.pagespeed.ic.DOAToGcDYE.webp') }}"
                alt=""></a>
        <div class="post-body">
            <div class="post-meta">
    ...
    <div class="post post-thumb">
        <a class="post-img" href="blog-post.html"><img src="{{ asset('images/img/xpost-1.jpg.pagespeed.ic.2GXRfHYjOg.webp') }}"
                alt=""></a>
        <div class="post-body">
            <div class="post-meta">
